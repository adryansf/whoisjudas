...
- TypeScript 5.x + Next.js 16 App Router, shadcn/ui (Dialog component), next-intl (005-rules-modal-button)
- N/A (i18n translations in JSON files) (005-rules-modal-button)
