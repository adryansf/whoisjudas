...
- 002-biblical-game-ui-remodel: Added TypeScript 5.x + Next.js 16 (App Router), TailwindCSS, shadcn/ui components
- 001-social-deduction-game: Added TypeScript 5.x + Next.js 15 (App Router), Socket.IO, React Query, shadcn/ui, next-intl, nanoid
