...
import { Separator } from "@whoisjudas/ui/components/separator";
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from "@whoisjudas/ui/components/sheet";
import { Skeleton } from "@whoisjudas/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@whoisjudas/ui/components/tooltip";
import { useIsMobile } from "@whoisjudas/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: document.cookie is still widely supported and appropriate here
